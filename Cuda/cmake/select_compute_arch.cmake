# This file is copied from https://github.com/pytorch/pytorch/blob/master/cmake/
# Modules_CUDA_fix/upstream/FindCUDA/select_compute_arch.cmake
#
...
# ARCH_AND_PTX : NAME | NUM.NUM | NUM.NUM(NUM.NUM) | NUM.NUM+PTX NAME: Kepler
# Maxwell Kepler+Tegra Kepler+Tesla Maxwell+Tegra Pascal Volta Turing Ampere
# NUM: Any number. Only those pairs are currently accepted by NVCC though: 3.5
# 3.7 5.0 5.2 5.3 6.0 6.2 7.0 7.2 7.5 8.0 Returns LIST of flags to be added to
# CUDA_NVCC_FLAGS in ${out_variable} Additionally, sets ${out_variable}_readable
# to the resulting numeric list Example: CUDA_SELECT_NVCC_ARCH_FLAGS(ARCH_FLAGS
# 3.0 3.5+PTX 5.2(5.0) Maxwell) LIST(APPEND CUDA_NVCC_FLAGS ${ARCH_FLAGS})
#
