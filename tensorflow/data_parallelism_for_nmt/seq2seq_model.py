...
class Seq2SeqModel(object):
    def __init__(self,
        ...
        self.fetches = self._make_parallel(
            self.build_graph,
            hparams=hparams,
            source=self.source,
    ...
    def _make_parallel(self, fn, **kwargs):
        ...
        return self._build_fetches(self.global_step, losses, device_grads)

    def _add_forward_pass_and_gradients(self, rel_device_num, abs_device_num,
                                        **inputs):
        """
        Args:
        ...
        with tf.device(self.devices[rel_device_num]):
            logits, loss, final_context_state = self.build_graph(
    ...
    def _build_fetches(self, global_step, losses, device_grads):
        fetches = {}
        ...
        avg_grads = self.variable_mgr.get_gradients_to_apply(gradient_state)
