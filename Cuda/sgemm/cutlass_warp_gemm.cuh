...
__global__ void GemmKernel(typename Mma::ElementC* output_C,
  ...
  using FragmentIterator = cutlass::epilogue::warp::FragmentIteratorTensorOp<
      typename Mma::Shape, cutlass::gemm::GemmShape<16, 8, 8>, cutlass::half_t,
      typename Mma::Policy::Operator::FragmentC, cutlass::layout::RowMajor>;
  using AccumulatorTileIterator =
      cutlass::epilogue::warp::TileIteratorTensorOpCanonical<
          typename Mma::Shape, cutlass::gemm::GemmShape<16, 8, 8>,
  ...
  for (uint bkIdx = 0; bkIdx < WholeShape::kK; bkIdx += ThreadblockShape::kK) {
    ...
    AccumulatorTileIterator dest_tile_it({tmp_warp_c, layout_C},
                                         cutlass::arch::LaneId());
