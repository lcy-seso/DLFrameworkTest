...
struct R2CTileLoader {
  ...
  // Ctor
  R2CTileLoader(int64_t row_size, int64_t col_size)
...
struct R2RTileLoader {
  ...
  // Ctor
  R2RTileLoader(int64_t row_size, int64_t col_size)
      : row_size(row_size), col_size(col_size) {}
...
struct C2CTileLoader {
  ...
  // Ctor
  C2CTileLoader(int64_t row_size, int64_t col_size)
      : row_size(row_size), col_size(col_size) {}
...
struct C2RTileLoader {
  ...
  // Ctor
  C2RTileLoader(int64_t row_size, int64_t col_size)
      : row_size(row_size), col_size(col_size) {}
